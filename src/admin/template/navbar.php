                    ...
                    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="./../favoris.php">Voir la page en tant qu'utilisateur</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark" style="padding-left: 10px">
                                        <li><a class="nav-link" href="#">Gestions des articles</a></li>
                                        <li><a class="nav-link" href="#">Gestions des plateformes</a></li>
