...
document.addEventListener("DOMContentLoaded", function () {
  const articlesPerPage = 3; // On affiche une limitation de 3 articles par page
  const articles = document.querySelectorAll(".container-favoris .card"); // Séléction des class container-favoris et card et on récupère les articles à l'intérieur
